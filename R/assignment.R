#' Assignment / "arbeidskrav" template (Nord University)
#'
#' R Markdown output format for a Nord University course assignment or
#' "arbeidskrav". Produces a PDF using xelatex with Times New Roman, a
#' Nord-branded title page and (optionally) a table of contents.
#'
#' @inheritParams master_mono
#'
#' @export
assignment <- function(toc = TRUE,
                       toc_depth = 4,
                       ...
                       md_extensions = NULL,
                       pandoc_args = NULL,
                       template = pkg_template("assignment.tex")) {
